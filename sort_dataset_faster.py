...
def sort_dataset(data,imagefolder,dest):
    ...
    for file in files:
        for i in range(len(data)):
            ...
            if data[i,0] == file and data[i,1] == 'Green': 
                copyFile(imagefolder+'/'+file,dest+'/Green')
            elif data[i,0] == file and data[i,1] == 'Blue': 
                copyFile(imagefolder+'/'+file,dest+'/Blue')
            elif data[i,0] == file and data[i,1] == 'Hazel': 
                copyFile(imagefolder+'/'+file,dest+'/Hazel')
            elif data[i,0] == file and data[i,1] == 'Brown': 
                copyFile(imagefolder+'/'+file,dest+'/Brown')
            elif data[i,0] == file and data[i,1] == 'Black': 
                copyFile(imagefolder+'/'+file,dest+'/Brown')
